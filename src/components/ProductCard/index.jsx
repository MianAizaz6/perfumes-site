...
const ProductCard = () => {
    return (
        <div className="flex flex-col md:h-[650px] h-[500px]  justify-evenly">
            <div className="shadow-[0px_4px_22px_-3px_#00000040] p-[30px] bg-gradient-to-tr overflow-hidden from-[#2B2B2B] to-[#101010] rounded-[9px]">
                <img className="h-[450px] object-contain mx-auto" src={cityScents} alt="" />
            </div>
